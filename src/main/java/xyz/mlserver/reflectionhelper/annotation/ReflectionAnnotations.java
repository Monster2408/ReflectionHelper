package xyz.mlserver.reflectionhelper.annotation;
...
import xyz.mlserver.reflectionhelper.resolver.wrapper.ClassWrapper;
import xyz.mlserver.reflectionhelper.resolver.wrapper.FieldWrapper;
import xyz.mlserver.reflectionhelper.resolver.wrapper.MethodWrapper;
...
public class ReflectionAnnotations {
	...
	public void load(Object toLoad) {
		...
		for (java.lang.reflect.Field field : toLoad.getClass().getDeclaredFields()) {
			java.lang.Class classAnnotation = field.getAnnotation(java.lang.Class.class);
			...
			if (classAnnotation != null) {
				List<String> nameList = parseAnnotationVersions(java.lang.Class.class, classAnnotation);
